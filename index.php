    ...
    <nav class="navbar navbar-default">
      ...
      <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="well">
            <h3 class="text-center blue">Panel de opciones</h3>
            <a href="asistencia.php" class="btn btn-info pull-right">Asistencia diaria</a>
            <a href="acumulado.php" class="btn btn-info pull-left">Acumulado de asistencias</a>
          </div>
        </div>
      </div>
